        ...
        var refugeSpaces = d3.select("#totalRefuge")
            ...
            .html(function(d) {
                if (boroughRefugeTotal.get(code) === undefined) {
                    ...
                    return
                        "<span id='spaces'>No </span> refuge spaces available";
                } else {
        ...
        var helplineCalls = d3.select("#helplineCalls")
            ...
            .html(function(d) {
                if (helplineCallsById.get(code) === undefined) {
                    ...
                    return
                        "<span id='helplinecalls'>No </span> calls to the National Domestic Violence Helpline recorded. ";
                } else {
        ...
        var arrivalsHeading = d3.select("#arrivalsHeading")
            ...
            .html(function(d) {
                if (boroughRefugeTotal.get(code) === undefined) {
                    ...
                    return
                        "<span id='arrivingH1'>Arriving to access refuge</span>";
                }
            })
            .attr("class", "tooltip_text");
        ...
        var arrivalsInfo = d3.select("#arrivalsInfo")
            ...
            .html(function(d) {
                if (boroughRefugeTotal.get(code) === undefined) {
                    ...
                    return
                        "<span id='arriving'>No </span> women were able to seek refuge in this borough.";
                } else {
        ...
        var originFromBoroughText = d3.select("#arrivalsInfo")
            ...
            .html(function(d) {
                if (boroughRefugeTotal.get(code) === undefined ||
                    ...
                    return
                        ". Of these, <span id='arriving'>none*</span> were from " +
        ...
        var departuresHeading = d3.select("#departuresHeading")
            ...
            .html(function(d) {
                if (refugeAccess.get(code) === undefined) {
                    ...
                    return
                        "<span id='leavingH1'>Leaving to seek refuge**</span>";
                }
            })
            .attr("class", "tooltip_text");
        ...
        var astrix = d3.select("#astrix")
            ...
            .html(function(d) {
                if (refugeAccess.get(code) === undefined) {
                    ...
                    return
                        "<span id='arrivingAstrix'>*</span>This is likely to be higher due to some unknown London or unspecified locations.<br><span id='leavingAstrix'>**</span>Where relevant, this includes women who stay in the borough. There is no data for those women leaving London to seek refuge.";
                }
            })
            .attr("class", "astrix");
        ...
        function showroutesOut(d) {
            ...
            var instructionJourneysOut = d3.select("#infowindowHeading")
                ...
                .html(function(d) {
                    if (boroughNameById.get(code) === undefined) {
                        return
                            "<span class='tooltip_heading'>Domestic Abuse Migration Map</span> <br><span class='tooltip_text'> Women's journeys to access refuge in London, April 2015 - March 2016<br><span id='instructionLeavinglH1'>Showing journeys leaving</span><br><b>Roll over</b> the London boroughs to discover the journeys women made.<br><b>Use the buttons above</b> the map to see all journeys or just those leaving.";
                    } else {
                        return null;
                    }
                })
            ...
            var helplineCalls = d3.select("#helplineCalls")
                ...
                .html(function(d) {
                    if (helplineCallsById.get(code) === undefined) {
                        ...
                        return
                            "There were <span id='helplinecalls'>no</span> calls to the National Domestic Violence Helpline recorded from " +
                            boroughNameById.get(code) + ".";
                    } else {
                ...
                .html(function(d) {
                    if (refugeAccess.get(code) === undefined) {
                        ...
                        return "Of the <span id='leaving'>" + refugeAccess.get(
                                code) + " </span>" + " women from " +
                            boroughNameById.get(code) +
                            " placed in a refuge in London*: ";
                    } else if (originBorough.get(code) < 2) {
                        return "Of the <span id='leaving'>" + refugeAccess.get(
                                code) + " </span>" + " woman from " +
                            boroughNameById.get(code) +
                            " placed in a refuge in London*:";
                    } else {
                        return "Of the <span id='leaving'>" + refugeAccess.get(
            ...
            var astrix = d3.select("#astrix2")
                ...
                .html(function(d) {
                    if (refugeAccess.get(code) === undefined) {
                        ...
                        return
                            "*Note there is no data for those women leaving London to seek refuge.";
                    }
                })
                .attr("class", "astrix");
