    ...
    function ready(error, uk, locations, routes) {
        ...
        //Display calls to action
    		...
    		d3.select("#instruction")
                .html( "<span class='tooltip_heading'>Domestic Abuse Migration Map</span> <br><span class='tooltip_text'> Women's journeys to access refuge in London, 1st April 2015 - 31st March 2016<br><br><span id='allH1'>Showing all journeys</span><br><br><b>Roll over</b> the London boroughs to discover the journeys women made<br><br><b>Use the buttons above</b> the map to see just those arriving or leaving");
        ...
        function showInfoIn () {
	            ...
	            d3.select("#instruction")
	                .html( "<span class='tooltip_heading'>Domestic Abuse Migration Map</span> <br><span class='tooltip_text'> Women's journeys to access refuge in London, 1st April 2015 - 31st March 2016<br><br><span id='arrivingH1'>Showing journeys arriving</span><br><br><b>Roll over</b> the London boroughs to discover the journeys women made<br><br><b>Use the buttons above</b> the map to see all journeys or just those leaving");
        ...
        function showInfoOut () {
            ...
            d3.select("#instruction")
                .html( "<span class='tooltip_heading'>Domestic Abuse Migration Map</span> <br><span class='tooltip_text'> Women's journeys to access refuge in London, 1st April 2015 - 31st March 2016<br><br><span id='leavingH1'>Showing journeys leaving</span><br><br><b>Roll over</b> the London boroughs to discover the journeys women made<br><br><b>Use the buttons above</b> the map to see all journeys or just those leaving");
